...
namespace Persistencia
{
    internal class PersistenciaArticulo:IPersistenciaArticulo
    {
        ...
        {
            SqlConnection oConexion = new SqlConnection(Conexion.Con(u));
            SqlCommand oComando = new SqlCommand("AltaArticulo", oConexion);
            oComando.CommandType = CommandType.StoredProcedure;

            SqlParameter _codigo = new SqlParameter("@cod", A.CodAr);
            SqlParameter _nombre = new SqlParameter("@nom", A.NomAr);
        ...
        public Articulo BuscarArticulo(int pCodigo)
        {
            ...
            SqlConnection oConexion = new SqlConnection(Conexion.Cnn);
            SqlCommand oComando = new SqlCommand("BuscoArticulo", oConexion);
            oComando.CommandType = CommandType.StoredProcedure;
        ...
        public List<Articulo> ListarArticulo()
        {
            ...
            SqlCommand _Comando = new SqlCommand("ListoArticulo", _Conexion);
